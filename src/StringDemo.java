...
public class StringDemo {
	...
	public static void main(String[] args) {
		...
		// String Object - Heap
		String strObject = new String("Welcome");
		...
		System.out.println("Index of 'q' is: " + str.indexOf('q')); //if does not exist in the String it returns -1
		...
		System.out.println("Substring Exmaple 1: " + str.substring(5));
		System.out.println("Substring Exmaple 2: " + str.substring(5, 10));
